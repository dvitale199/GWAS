...
geno_ancestry = geno_sex + "_heterozyg_hapmap"
geno_relatedness = geno_ancestry + "_relatedness"
...
qc.ancestry_comparison(geno_sex, ref)
qc.relatedness_pruning(geno_ancestry)
